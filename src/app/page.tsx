        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-4">
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl border border-gray-700/50 p-6 shadow-2xl h-fit">
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Manage your limits</p>
                  </div>
                </div>
                <SessionManager 
                  session={session} 
            ...
            <div className="lg:col-span-8">
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl border border-gray-700/50 p-6 shadow-2xl">
                ...
                <TradeInterface session={session} />
              </div>
            </div>
          </div>
        </div>
